  ...
  const sections = useMemo(
    () => [
      ...
      },
      {
        ...
        title:
          "Create exceptional digital experiences that engage users",
        description:
          "We craft intuitive, beautiful, and high-performing applications that combine modern design principles with robust development practices.",
        bullets: [
